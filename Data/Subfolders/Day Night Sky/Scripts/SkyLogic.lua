...
local dayColors = {
	...
	Color.New(0/255, 206/255, 255/255, 230/255), -- 00CEFFE6
	Color.New(0/255, 98/255, 255/255, 174/255), -- 0062FFAE,
...
local sunRiseColors = {
	-- haze, horizon, zenith
	Color.New(1, 0.671, 0.692, 1), -- FFABB1FF
	Color.New(1, 0.152731, 0.607738, 0.901961), -- FF279BE6
	Color.New(0.267688, 0, 0.86, 0.6), -- 1E377E99
	-- cloud, cloud rim, cloud ambient
...
local nightColors = {
	-- haze, horizon, zenith
	Color.New(0.141176, 0.160784, 0.509804, 1), -- 242982FF
	Color.New(40/255, 44/255, 58/255, 98/255), -- 283C9E62
